<fieldset>
    <div class="form-group">
        ...
        <input type="text" name="word"
               value="<?php echo htmlspecialchars(($edit ? $dictlist['word'] : '') ?: '', ENT_QUOTES, 'UTF-8'); ?>"
    ...
    <div class="form-group">
        ...
        <input type="text" name="translate"
               value="<?php echo htmlspecialchars(($edit ? $dictlist['translate'] : '') ?: '', ENT_QUOTES, 'UTF-8'); ?>"
    ...
    <div class="form-group">
        ...
        <textarea name="dict_ref" placeholder="Ссылка на словарь" class="form-control"
                  id="dict_ref"><?php echo htmlspecialchars((($edit) ? $dictlist['dict_ref'] : '') ?: '', ENT_QUOTES, 'UTF-8'); ?></textarea>
    </div>
